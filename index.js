...
fetch(`https://www.mapquestapi.com/directions/v2/route?key=WOOm9BsTrflfVpN5PJw9sLtj5DQsfGgB&from=Clarendon+Blvd,Arlington,VA&to=2400+S+Glebe+Rd,+Arlington,+VA`).then(function (response) {
    console.log('Success!');
    //return 0;
}).then(function (data) {
    console.log(data);
